...
o
   ...
   it does the same thing - Math.min(1,2,3,-5)



   //Control Flow
    Statements are executed as a story from top to bottom

     Number.isNaN - function is a standard JavaScript function that returns true only if the arguments it is given is NaN.
